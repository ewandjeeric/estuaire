...
<html>
    ...
    <body>
        <nav class="navbar navbar-light navbar-expand-lg shadow-sm bg-white navbar-laravel">
            <div class="container">
                <a href="index.html" class="navbar-brand" style="font-family: 'Comic Sans MS';color: #333333; text-shadow: 2px 2px 0px #FFFFFF, 5px 4px 0px rgba(0,0,0,0.15); font-size: 25px;">Centre medicale de l'estuaire</a>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="date"  class="form-control" id="jour" aria-describedby="basic-addon3" name="jour">
                                            </div>
                                        </div>
                                       ...
                                       <label for="basic-url" class="lead"><i class="fas fa-male fa-2x"></i> Patient</label>
                                        <div class="input-group mb-3" style="border: 1px solid #ced4da; padding: 10px; width: 425px; border-radius: 5px 5px 5px;">
                                     <div class="custom-control custom-radio custom-control-inline">
                                     <input type="radio" id="customRadioInline1" name="patient" class="custom-control-input" value="ancien">
                                       <label class="custom-control-label" for="customRadioInline1">Ancien patient</label>
                                   </div>
                                  <div class="custom-control custom-radio custom-control-inline">
                                  <input type="radio" id="customRadioInline2" name="patient" class="custom-control-input" value="nouveau">
